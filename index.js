...
var unix_timestamp = function(unix_timestamp) {
      ...
      request({ url: url, json: true }, function (error, response) {
        if (error) {
          ...
          console.log('It is currently '+ Math.round(response.body.main.temp - 273.15)+ '°C degrees out.');
            ...
            console.log('Sunrise : ' + unix_timestamp(response.body.sys.sunrise));
            console.log('Sunset : ' + unix_timestamp(response.body.sys.sunset));
